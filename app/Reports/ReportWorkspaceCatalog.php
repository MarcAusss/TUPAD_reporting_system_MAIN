        ...
        return [
            ...
            'fund-status' => [
                ...
                'items' => [
                    ...
                    $this->availableItem('Summary per ADL', 'Approved fund-status summary grouped by ADL with allocation breakdown and subtotals.', ReportType::FUND_STATUS, ReportDimension::ADL),
                    $this->availableItem('Summary per Province', 'Approved fund-status summary grouped by province with ADL allocation breakdown and subtotals.', ReportType::FUND_STATUS, ReportDimension::PROVINCE),
