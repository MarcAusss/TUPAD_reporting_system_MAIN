...
@section('content')
    ...
    <x-page-header eyebrow="Project Summary" title="Provincial Summary"
    ...
    <section class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="relative w-full sm:w-80">
                <input id="provinceCardSearch" type="search" placeholder="Search province..."
        ...
        <div id="provinceSummaryCards" class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">

            @foreach ($provinces as $item)
                <a href="{{ route('project-summary.province', $item['province']) }}"
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-50 text-[#063b86] transition group-hover:bg-[#063b86] group-hover:text-white">
