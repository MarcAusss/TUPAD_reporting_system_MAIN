...
@if($dashboardMode === 'gip')
    ...
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        @foreach([
            ['All Drafts', $totalDrafts, 'Project drafts encoded by your account.'],
            ['Pending TC Review', $pendingDrafts, 'Submitted drafts waiting for TC review.'],
            ['Returned', $returnedDrafts, 'Drafts requiring correction or clarification.'],
            ['Confirmed', $confirmedDrafts, 'Drafts successfully confirmed by TC.'],
    ...
    <div class="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
        ...
        <section class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="divide-y divide-slate-100">
                ...
                @forelse($recentDrafts as $draft)
                    ...
                    <a
                        href="{{ route('project-drafts.show', $draft) }}"
        ...
        <aside class="rounded-xl border border-blue-200 bg-blue-50 p-5">
            ...
            <ol class="mt-4 space-y-4">
                ...
                @foreach([
                    ['1', 'Create or update a draft', 'Encode the project information assigned to GIP.'],
                    ['2', 'Submit for TC review', 'The TUPAD Coordinator validates the draft.'],
                    ['3', 'Correct returned drafts', 'Update only the items requested for correction.'],
                    ['4', 'Wait for confirmation', 'Confirmed drafts become available to the official workflow.'],
                ] as [$step, $title, $description])

                    <li class="flex gap-3">

                        <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-100 text-xs font-bold text-blue-800">
                            {{ $step }}
                        </div>
    ...
    >
        <x-slot:actions>
            ...
            @elseif($roleMode === 'tc')
                ...
                <a
                    href="{{ route('project-workflow.index', ['queue' => 'tssd-evaluation']) }}"
                    class="inline-flex h-10 items-center rounded-lg border border-slate-300 bg-white px-4 text-sm font-semibold text-slate-700 hover:bg-slate-50"
                >
                    Open Workflow
                </a>
    ...
    @if(in_array($roleMode, ['tc', 'admin'], true))
        ...
        <section class="mb-5">
            ...
            <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
                ...
                @foreach([
                    ['tssd-evaluation', 'TSSD Evaluation', $workflowCounts['tssd']],
                    ['for-approval', 'For Approval', $workflowCounts['approval']],
                    ['implementation', 'Implementation', $workflowCounts['implementation']],
                    ['post-documents', 'Post-Documents', $workflowCounts['post_documents']],
                    ['release-of-assistance', 'Release of Assistance', $workflowCounts['release']],
                    ...
                    >
                        ...
                        <div class="text-[10px] font-bold uppercase tracking-[0.08em] text-slate-400 group-hover:text-blue-600">
                            Pending Queue
                        </div>
    ...
    <div class="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
        ...
        <section class="tupad-card overflow-hidden">
            ...
            <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                ...
                <div class="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-[10px] font-bold text-slate-500">
                    FY {{ $currentYear }}
                </div>
            ...
            <div class="px-4 pb-4 pt-3 sm:px-5">
                ...
                <svg
                    ...
                    aria-label="Cumulative project cost trend"
                >
                    <defs>
                        <linearGradient
                            id="trendFill"
        ...
        <aside class="tupad-card p-5">
            ...
            @else
                ...
                <div class="mt-5 rounded-lg border border-slate-200 bg-slate-50 px-3 py-3 text-center text-[11px] text-slate-500">
